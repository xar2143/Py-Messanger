...
class MessengerClient:
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Messenger Chat")
    ...
    def setup_gui(self):
        ...
        self.entry_nickname.insert(0, "Utente1")
        self.entry_nickname.bind('<Return>', lambda e: self.connetti_chat())
    ...
    def connetti_chat(self):
        ...
        if not self.nickname:
            messagebox.showerror("Errore", "Inserisci il tuo nickname!")
            ...
            for tentativo in range(MAX_TENTATIVI):
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        self.root.after(0, lambda: self.connessione_fallita("Nickname già in uso! Scegline un altro."))
                        break
                    else:
                        data = response.json()
    ...
    def disconnetti_server(self):
        ...
        self.entry_nickname.config(state='normal')
        self.btn_connetti.config(state='normal')
